...
test.beforeEach(async ({ context }) => {
  await context.route('**/*', r => {
    ...
    // Keep the checkout navigation real for the assertion, but return a tiny
    // deterministic page instead of aborting a top-level Whop navigation.
    // Aborting that navigation can crash WebKit mobile targets.
