...
function safeCapture(event,props){if(window.posthog&&typeof window.posthog.capture==='function'){window.posthog.capture(event,props||{})}}

function initAnalytics(){
  if(location.pathname.indexOf('/preview/')===0)return;
  !function(t,e){var o,n,p,r;e.__SV||(window.posthog&&window.posthog.__loaded)||(window.posthog=e,e._i=[],e.init=function(i,s,a){function g(t,e){var o=e.split('.');2==o.length&&(t=t[o[0]],e=o[1]),t[e]=function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}}p||((p=t.createElement('script')).type='text/javascript',p.crossOrigin='anonymous',p.async=!0,p.src=s.api_host.replace('.i.posthog.com','-assets.i.posthog.com')+'/static/array.js',p.onerror=function(){p=null},(r=t.getElementsByTagName('script')[0]).parentNode.insertBefore(p,r));var u=e;for(void 0!==a?u=e[a]=[]:a='posthog',u.people=u.people||[],u.toString=function(t){var e='posthog';return'posthog'!==a&&(e+='.'+a),t||(e+=' (stub)'),e},u.people.toString=function(){return u.toString(1)+'.people (stub)'},o='init capture register register_once unregister getFeatureFlag isFeatureEnabled identify reset get_distinct_id opt_in_capturing opt_out_capturing'.split(' '),n=0;n<o.length;n++)g(u,o[n]);e._i.push([i,s,a])},e.__SV=1)}(document,window.posthog||[]);
  posthog.init('phc_m92yxHMa2BTnSu7KmebGKu8sEitMki4oPhdLTKZzcpMc',{api_host:'https://edge.slayerkey.com',ui_host:'https://us.posthog.com',defaults:'2026-05-30',strict_script_versioning:true});
  safeCapture('portfolio_view',{page:'work'});
}
initAnalytics();
...
function hide(){modal.classList.remove('open');modal.setAttribute('aria-hidden','true');if(lastFocus&&typeof lastFocus.focus==='function')lastFocus.focus()}
function openMail(){safeCapture('portfolio_contact_email');var subject=encodeURIComponent('Portfolio inquiry');window.location.href='mailto:'+email()+'?subject='+subject}
document.querySelectorAll('.contact-trigger').forEach(function(btn){btn.addEventListener('click',show)});
modal.querySelector('#open-email').addEventListener('click',openMail);modal.querySelector('#close-email').addEventListener('click',hide);modal.querySelector('.contact-close').addEventListener('click',hide);modal.addEventListener('click',function(e){if(e.target===modal)hide()});document.addEventListener('keydown',function(e){if(e.key==='Escape'&&modal.classList.contains('open'))hide()});
})();
